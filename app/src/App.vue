  ...
  <v-app id="inspire">
    ...
    <v-app-bar :clipped-left="$vuetify.breakpoint.lgAndUp" app color="blue darken-3" dark>
      ...
      <v-toolbar-title style="width: 300px" class="ml-0 pl-4">
        <span class="hidden-sm-and-down">Gebetstagebuch</span>
      </v-toolbar-title>
      <v-text-field
        flat
        solo-inverted
...
export default {
  ...
  data: () => ({
    ...
    drawer: null,
    items: [
      { icon: 'mdi-description', text: 'Meine Anliegen' },
      { icon: 'mdi-description', text: 'Meine Gebete' },
      { icon: 'mdi-history', text: 'Meine Erhörungen' },
      // {
      //   icon: 'mdi-chevron-up',
      ...
      { icon: 'mdi-message', text: 'Kritik oder Lob?' },
